<template>
    <div class="container">
        ...
        <div class="row d-block d-flex ">
            <div class="row"><br>
                <h4 class="display-6" id="shopAll">Shop All</h4> <br>

                <div class="col">
                    <!-- Search input -->
                    <br><input @keyup="searchProduct()" id="search1" type="text" placeholder=" Search by name..."
                        class="form-control" ref="inputField" v-model="searchData">
                </div>
                ...
                <div class="col d-flex justify-content-end">
                    ...
                    <!-- sort button -->
                    <button @click="sortedProducts()" class="btn btn-light"
                        style="padding: 5px; font-size: small; width: 5.5rem;">
                        Sort by
                    </button>
                </div>
            </div>
