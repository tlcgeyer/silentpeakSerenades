<template>
  <div>
    ...
    <div class="d-flex justify-content-center align-items-center flex-column">
      <router-link to="/">
        <img src="https://i.ibb.co/DfHHJTg/Screenshot-2024-03-01-232254.png" alt="logo" class="logo">
      </router-link>
    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top" id="navbarr">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav mx-auto" style="font-family: 'Barlow';">
            <li class="nav-item">
            ...
            <li class="nav-item">
              <router-link to="/instruments" class="nav-link">Store</router-link>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <router-link to="/login" class="nav-link" style="font-size: small;">Register/Login</router-link>
            </li>
            <li class="nav-item">
              <router-link to="/account" class="nav-link"> <svg width="27" height="27" viewBox="0 0 24 24" fill="none"
            ...
            <li class="nav-item">
              <router-link to="/checkout" class="nav-link"><svg width="20" height="21" viewBox="0 0 20 21" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
