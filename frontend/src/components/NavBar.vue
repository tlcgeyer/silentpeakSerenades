    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <div class="justify-content-center inline-block d-flex w-100 ">
          <ul class="navbar-nav" style="font-family: 'Barlow'; margin-left: 10%">
            <li class="nav-item">
            ...
            <li class="nav-item">
              <router-link to="/login" class="nav-link"
                style="font-size: x-small; font-weight: 700; margin-left: 300%; margin-top: 10%">Register/Login</router-link>
            </li>

            <li class="nav-item">
              <router-link to="/account" class="nav-link" style="margin-left: 300%;"> <svg width="27" height="27"
            ...
            <li class="nav-item">
              <router-link to="/checkout" class="nav-link"><svg width="20" height="21" viewBox="0 0 20 21" fill="none"
                  xmlns="http://www.w3.org/2000/svg" style="margin-left: 1200%; ">
                  <path
