          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <router-link to="/register" class="nav-link"
                style="font-size: small; font-weight: 700; justify-content: end;">Register</router-link>
              <router-link to="/login" class="nav-link" style="font-size: small; font-weight: 700">Login</router-link>
            </li>


            <li class="nav-item">
              <router-link to="/account" class="nav-link"> <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
