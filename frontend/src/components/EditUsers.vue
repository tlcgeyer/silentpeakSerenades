<template>
      <button type="button" class="btn modalButton btn btn-primary" data-bs-toggle="modal" data-bs-target="#updateUserModal" >
      Edit
      </button>
      ...
      <div class="modal-body">
        <form @submit.prevent="editUser">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" @click.prevent="updatingUsers(payload)"  class="btn btn-success" data-bs-dismiss="modal">Save changes</button>
          </div>
        </form>
      </div>
    </div>
