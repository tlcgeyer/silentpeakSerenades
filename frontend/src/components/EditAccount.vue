<template>
    <button type="button" class="btn modalButton btn " data-bs-toggle="modal" data-bs-target="#updateAccountModal" >
...
<div class="modal-dialog" >
  <div class="modal-content">
    ...
    <div class="modal-body">
      <form @submit.prevent="updatingAccount">
        <div class="mb-3">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" @click.prevent="updatingAccount(payload)"  class="btn btn-success" data-bs-dismiss="modal">Save changes</button>
        </div>
      </form>
    </div>
  </div>
